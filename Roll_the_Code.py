#this example script decrypts given key frame, set cmd to unlock, increment the rolling code counter, calculates checksum and encrypt the new
#generated key. You can verify the new generated key with original output from Golf4.sub
